...
resource "azurerm_virtual_machine" "vm-linux-with-datadisk" {
  ...
  os_profile_linux_config {
    ...
    ssh_keys {
      path     = "/home/${var.admin_username}/.ssh/authorized_keys"
      key_data = "ssh-rsa  grajan002@US_C02XH4FJJG5J"
    }
  }
